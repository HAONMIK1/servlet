...
substring(str1, 7, 10) = "${fn:substring(str1, 7, 10)}" <br><br> 
...
${arr}<br>
<c:set var="arrlen" value="${fn:length(arr)}"/>
${arrlen}
<br>
<c:forEach begin="0" end="${ arrlen}" var="a">
<c:set var="total" value="${arr[a]+total}"/>
${arr[a]+total}
</c:forEach>
${total }
